                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" name="coupon_name" type="text" id="example-text-input" value="{{ $coupon->coupon_name }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" name="coupon_desc" type="text" id="example-text-input" value="{{ $coupon->coupon_desc }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" name="discount" type="text" id="example-text-input" value="{{ $coupon->discount }}">
                            </div>
                        </div>
